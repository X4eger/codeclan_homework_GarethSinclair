...
-- Find the first_name, last_name and salary of the 
...
-- Return a table containing each employees 
-- first_name, last_name, full-time equivalent hours (fte_hours), 
-- salary, and a new column effective_yearly_salary which should 
...
-- The corporation wants to make name badges for a 
-- forthcoming conference. Return a column badge_label 
-- showing employees’ first_name and last_name joined together 
-- with their department in the following style: ‘Bob Smith - Legal’. 
-- Restrict output to only those employees with stored first_name, 
...
-- One of the conference organisers thinks it would be 
-- nice to add the year of the employees’ start_date to 
-- the badge_label to celebrate long-standing colleagues, 
...
-- Return the first_name, last_name and salary 
-- of all employees together with a new column 
-- called salary_class with a value 'low' where 
-- salary is less than 40,000 and value 'high' where 
